...
class TestMovimientos extends FlatSpec with Matchers {
  ...
  val bulma = Guerrero(Humano(), 100, List(), Set(), Normal)
  val mrSatan = Guerrero(Humano(), 1000, List(), Set(), Normal)
  val goku = Guerrero(Saiyajin(true, 3), 20000, List(), Set(), Normal)
  val androide18 = Guerrero(Androide(1000), 0, List(), Set(), Normal)
  ...
  "mrSatan" should "no hacer nada  cuando useItem Romo ya que no lo tiene en su inventario" in {
    ...
    val humanito = Guerrero(Humano(), 1, List(), Set(), Normal)
  ...
  "bulma" should "quedar iconsciente al recibir ataque con item Romo y tener menos de 300 de ki" in {
    ...
    val humanoConItemRomo = Guerrero(Humano(), 1000, List(Roma()), Set(), Normal)
   ...
   "bulma" should "quedar nomal al recibir ataque con item Romo de alguien que no posee dicho item aunque tiene menos de 300 de ki" in {
    ...
    val humanoSinItemRomo = Guerrero(Humano(), 1000, List(), Set(), Normal)
